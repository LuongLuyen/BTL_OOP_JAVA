...
<body>
	<div class="admin__app">
		...
		<div class="admin__filter">
			...
			<div class="filter__admin">
				<div class="filter__btn">Phổ biến</div>
			</div>
			<div class="filter__admin">
			...
			<div class="filter__admin">
				<input class="filter__input" placeholder="Tìm kiếm" /> <span
					class="search">Filter</span> <a class="admin__navi"
		...
		<div class="admin__content">
			<div class="admin__nav">
				...
				<div class="admin__nav-item">Sản phẩm 1</div>
				<div class="admin__nav-item">Sản phẩm 2</div>
				<div class="admin__nav-item">Sản phẩm 3</div>
				<div class="admin__nav-item">Sản phẩm 4</div>
				<div class="admin__nav-item">Sản phẩm 5</div>
				<div class="admin__nav-item">Sản phẩm 6</div>
			</div>
						...
						<tr>
							...
							<th class="thao__tacd">
								<form action="<c:url value='/admin'/>" method="post">
									<input type="hidden" name="idString" value="${item.id}"> <input
